...
Функция ПолучитьМножитель(ЕдиницаИзмерения)
	...
	МЗ = РегистрыСведений.МножителиЕдиницИзмерения.СоздатьМенеджерЗаписи();
	МЗ.ЕдиницаИзмерения = ЕдиницаИзмерения;
	МЗ.ВидЕдиницыИзмерения = ЕдиницаИзмерения.ВидЕдиницыИзмерения;
	МЗ.Прочитать();
	
	Возврат МЗ.Множитель;
